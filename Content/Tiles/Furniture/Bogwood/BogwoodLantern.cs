...
namespace AAMod.Content.Tiles.Furniture.Bogwood
{
	public class BogwoodLantern : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Bogwood Lantern");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new Vector2(i, j) * 16f, ModContent.ItemType<Items.Placeables.Furniture.Bogwood.BogwoodLantern>());
