...
namespace AAMod.Content.Tiles.Furniture.Razewood
{
	public class RazewoodChest : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(100, 87, 65), name, MapChestName);
			...
			ContainerName.SetDefault("Razewood Chest");
			ChestDrop = ModContent.ItemType<Items.Placeables.Furniture.Razewood.RazewoodChest>();
		}
