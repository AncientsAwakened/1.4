...
{
	public class RazewoodTorch : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			if (!Main.dedServ)
			{
				flameTexture = ModContent.Request<Texture2D>("AAMod/Content/Tiles/Furniture/Razewood/RazewoodTorch_Glow");
			}

			ItemDrop = ModContent.ItemType<Items.Placeables.Furniture.Razewood.RazewoodTorch>();
		...
		{
			bool inInfernoUndergroundBiome = Main.LocalPlayer.InModBiome(ModContent.GetInstance<InfernoUndergroundBiome>());
			return inInfernoUndergroundBiome ? 1f : -0.1f;
		}
