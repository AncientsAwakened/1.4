...
namespace AAMod.Content.Items.Weapons.FreedomStars
{
    class FreedomStar : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 200;
            Item.shoot = ModContent.ProjectileType<FreedomProjectile>();
        }
        public override bool AltFunctionUse(Player player)
        {
            ...
            else if (player.HeldItem.GetGlobalItem<AAGlobalItemModular>().OutputWeapon)
            {
        ...
        public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            ...
            spriteBatch.Draw(glowMask.Value, position, frame, new Color(23, 13, 182), 0f, origin, scale, SpriteEffects.None, 0f);
        }
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            Asset<Texture2D> glowMask = ModContent.Request<Texture2D>("AAMod/Content/Items/Weapons/FreedomStars/FreedomStar_Glow");
            spriteBatch.Draw(glowMask.Value, new Vector2(Item.position.X - Main.screenPosition.X + Item.width * 0.5f, Item.position.Y - Main.screenPosition.Y + Item.height - glowMask.Height() * 0.5f + 2f), new Rectangle(0, 0, glowMask.Width(), glowMask.Height()), new Color(23, 13, 182), rotation, glowMask.Size() * 0.5f, scale, SpriteEffects.None, 0f);
        }
    ...
    public class FreedomProjectile : ModProjectile
    {
                ...
                switch (chargeLevel)
                {
                    case 1:
                        if (player.HeldItem.GetGlobalItem<AAGlobalItemModular>().CurrentEnergy >= 50)
                        {
                            ...
                            player.HeldItem.GetGlobalItem<AAGlobalItemModular>().EnergyCooldown = true;
                            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), vector2.X, vector2.Y, SpeedX, SpeedY, ModContent.ProjectileType<FreedomNormalShot>(), Projectile.damage, 1f, Projectile.owner);
                        } 
                        break;
                    case 2:
                        if (player.HeldItem.GetGlobalItem<AAGlobalItemModular>().CurrentEnergy >= 150)
                        {
                            ...
                            player.HeldItem.GetGlobalItem<AAGlobalItemModular>().EnergyCooldown = true;
                            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), vector2.X, vector2.Y, SpeedX, SpeedY, ModContent.ProjectileType<FreedomChargeShot>(), Projectile.damage * 2, 1f, Projectile.owner);
                        }
                        break;
                    case 3:
                        if (player.HeldItem.GetGlobalItem<AAGlobalItemModular>().CurrentEnergy >= 150)
    ...
    class FreedomNormalShot : ModProjectile
    {
        public override void SetStaticDefaults()
        {
    ...
    class FreedomChargeShot : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Freedom Blast");
            Main.projFrames[Projectile.type] = 3;
        }
        public override void SetDefaults()
        {
