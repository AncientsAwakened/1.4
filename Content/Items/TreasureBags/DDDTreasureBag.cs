...
using AAMod.Content.NPCs.Bosses.DDD;

namespace AAMod.Content.Items.TreasureBags
{
	public class DDDTreasureBag : ModItem
	{
		public override int BossBagNPC => ModContent.NPCType<DDD>();

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Treasure Bag (Drone Dispensary Delta)");
