...
{
	public class RazewoodTorch : TileItem<Tiles.Furniture.Razewood.RazewoodTorch>
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Inferno Torch");
		...
		{
			CreateRecipe(3).AddIngredient(ItemID.Torch, 3).AddIngredient(ModContent.ItemType<Blocks.Razewood>()).Register();
		}
	}
}
